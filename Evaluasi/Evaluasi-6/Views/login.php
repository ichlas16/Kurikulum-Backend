                ...
                if(isset($_POST['login'])){
                    ...
                    if($user['username'] === $username){
                        ...
                        if($user['password'] === $password){
                            ...
                            echo '<img class="img img-responsive" src="../Models/img/incorrect.svg" />';
                        }else{
                            echo "Mau lu apa si?";
                        }
                    }elseif($user['username'] !== $username){
                        echo "<span>Harap periksa kembali username anda</span>";
                        echo "<p>Username ini belum terdaftar, ingin membuat akun? <a href='register.php'>Daftar di sini</a></p>";
                        echo '<img class="img img-responsive" src="../Models/img/incorrect.svg" />';
                        session_unset();
                    }else{
                        echo "Mau lu apa si?";
                    ...
                    echo '<img class="img img-responsive" src="../Models/img/login.svg" />';
                }
                ?>
            </div></center>
        </div>
